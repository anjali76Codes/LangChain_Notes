...
class Review(BaseModel):
    ...
    key_themes: list[str] = Field(
        description="All key themes discussed in the review in a list"
    )
    summary: str = Field(description="A brief summary of the review content")
    sentiment: Literal["Positive", "Negative"] = Field(
        description="Overall sentiment expressed in the review (e.g., positive, neutral, negative)"
    )
